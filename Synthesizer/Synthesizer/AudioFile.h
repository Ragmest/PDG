...
public:
	 ...
	 */
	bool save(std::string filePath, AudioFileFormat format = AudioFileFormat::Wave) const;
...
private:
	...
	//=============================================================
	bool saveToWaveFile(std::string filePath) const;
	bool saveToAiffFile(std::string filePath) const;
	...
	//=============================================================
	T sixteenBitIntToSample(int16_t sample) const;
	int16_t sampleToSixteenBitInt(T sample) const;

	//=============================================================
	uint8_t sampleToSingleByte(T sample) const;
	T singleByteToSample(uint8_t sample) const;

	uint32_t getAiffSampleRate(std::vector<uint8_t>& fileData, int sampleRateStartIndex) const;
	bool tenByteMatch(std::vector<uint8_t>& v1, int startIndex1, std::vector<uint8_t>& v2, int startIndex2) const;
	void addSampleRateToAiffData(std::vector<uint8_t>& fileData, uint32_t sampleRate) const;
	T clamp(T v1, T minValue, T maxValue) const;

	//=============================================================
	void addStringToFileData(std::vector<uint8_t>& fileData, std::string s) const;
	void addInt32ToFileData(std::vector<uint8_t>& fileData, int32_t i, Endianness endianness = Endianness::LittleEndian) const;
	void addInt16ToFileData(std::vector<uint8_t>& fileData, int16_t i, Endianness endianness = Endianness::LittleEndian) const;

	//=============================================================
	bool writeDataToFile(std::vector<uint8_t>& fileData, std::string filePath) const;
